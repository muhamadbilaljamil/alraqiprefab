                    ...
                    <div className="token-allocation-list-column">
                        <div className="token-allocation-first-row">
                            ...
                            <ul className="status-bars-list">
                                <li style={{'--color': '#CC0000', '--height': '152px', '--mobile-height': '85px'}}
                                    onMouseEnter={() => handleOnMouseEnter(1)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>10%</h4>
                                    <div className="icon"><img src={mobile_package_tracking} alt="icon_image"/></div>
                                </li>
                                <li style={{'--color': '#E76126', '--height': '386px', '--mobile-height': '185px'}}
                                    onMouseEnter={() => handleOnMouseEnter(2)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>25%</h4>
                                    <div className="icon"><img src={people} alt="icon_image"/></div>
                                </li>
                                <li style={{'--color': '#3C551C', '--height': '175px', '--mobile-height': '93px'}}
                                    onMouseEnter={() => handleOnMouseEnter(3)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>13%</h4>
                                    <div className="icon"><img src={trophy} alt="icon_image"/></div>
                                </li>
                                <li style={{'--color': '#806BEC', '--height': '240px', '--mobile-height': '135px'}}
                                    onMouseEnter={() => handleOnMouseEnter(4)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>17%</h4>
                                    <div className="icon"><img src={project_manager} alt="icon_image"/></div>
                                </li>
                                <li style={{'--color': '#215292', '--height': '187px', '--mobile-height': '115px'}}
                                    onMouseEnter={() => handleOnMouseEnter(5)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>15%</h4>
                                    <div className="icon"><img src={sankey} alt="icon_image"/></div>
                                </li>
                                <li style={{'--color': '#00ADAB', '--height': '320px', '--mobile-height': '160px'}}
                                    onMouseEnter={() => handleOnMouseEnter(6)} onMouseLeave={() => setShowCards(0)}>
                                    <h4>20%</h4>
